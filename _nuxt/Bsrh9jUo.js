...
import{e as M,a5 as B,o as b,c as f,b as s,V as w,W as P,f as o,U as S,Y as U,F as j,w as E,t as C,h as T,v as I,d as y,a0 as N}from"./C0XzcZgm.js";import{u as L}from"./DlPnO2XI.js";import"./CK3sEDda.js";const R={class:"space-y-6"},z={key:0,class:"flex items-center gap-4"},H=["value"],F={class:"flex gap-2"},W=["onClick"],Y={key:1},q=["disabled"],G={key:2},K=["disabled"],Q={key:3,class:"text-red-500 text-sm"},X={key:4},Z={class:"flex items-center justify-between mb-2"},ee={class:"w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-3 bg-gray-50 dark:bg-gray-900 font-mono text-sm overflow-auto max-h-64 whitespace-pre-wrap"},te=`syntax = "proto3";
