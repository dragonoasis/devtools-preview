const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./DacJbz9l.js","./ClG9gD6O.js","./entry.BYFYrDZ0.css","./CE1G-McA.js"])))=>i.map(i=>d[i]);
import{e as P,A as j,a5 as _,o as c,c as u,b as t,V as D,Y as A,f as o,U as R,F as S,w as L,t as h,W as F,d as m,a0 as V}from"./ClG9gD6O.js";const Y={class:"space-y-6"},N={class:"flex flex-wrap items-center gap-4"},G=["value"],I={class:"flex gap-1 flex-wrap"},q=["onClick"],H={class:"grid grid-cols-1 lg:grid-cols-2 gap-4"},z={class:"flex items-center justify-between mb-2"},Q={class:"flex gap-2"},W=["disabled"],$=["disabled"],J=["innerHTML"],K={key:1,class:"text-red-500 text-sm text-center whitespace-pre-wrap"},X={key:2,class:"text-gray-400 text-sm"},te=P({__name:"component",setup(Z){const l=m(`graph TD
