import{d as D,a7 as N,o as a,c as o,a as t,w as A,v as j,b as l,s as L,t as n,f as i,F as h,x as b,n as k,e as q,y as v,z as P}from"./Cm2mFNgr.js";import{j as B}from"./B5MQNTTm.js";const U={class:"space-y-6"},V={key:0,class:"text-red-500 text-sm mt-1"},J={key:0,class:"bg-gray-50 dark:bg-gray-800 rounded-xl p-4"},M={class:"text-xl font-bold"},Y={class:"flex gap-3 text-sm text-gray-500 mt-1"},F={key:0},W={key:1},z={key:0,class:"text-sm mt-2"},G={class:"text-lg font-semibold mb-3"},H={class:"space-y-2"},R=["onClick"],Q={class:"font-mono text-sm"},K={class:"text-sm text-gray-500 ml-auto"},X={key:0,class:"px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 text-sm space-y-2"},Z={key:0},ee={key:1},te={key:2},se={class:"ml-4 mt-1 space-y-1"},re={class:"text-gray-400 ml-1"},ae={key:0,class:"text-red-500 text-xs ml-1"},oe={key:1,class:"text-blue-500 text-xs ml-1"},ne={key:3},le={class:"ml-4 mt-1 space-y-1"},ie={class:"text-gray-500 ml-2"},de={key:1},ce={class:"text-lg font-semibold mb-3"},pe={class:"space-y-2"},ue=["onClick"],me={class:"font-mono font-semibold"},ge={class:"text-sm text-gray-500"},ye={key:0,class:"px-4 py-3 border-t border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900"},he={key:0,class:"space-y-1 text-sm"},xe={class:"text-blue-500 text-xs"},fe={key:0,class:"text-gray-400 text-xs"},be={key:1,class:"text-red-500 text-xs"},ve={key:1,class:"text-xs overflow-auto"},_e=`openapi: "3.0.3"
info:
  title: Pet Store API
  version: "1.0.0"
