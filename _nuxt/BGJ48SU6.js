...
import{aE as T,g as D,as as H,o as g,c as v,f as s,N as u,an as x,aq as S,x as r,a3 as k,az as M,a1 as O,a2 as C,R as E,ad as V,t as h,z as I}from"./DwUGk4tV.js";import{d as A,a as z}from"./BwrctbU_.js";import{u as R}from"./DBkJBJD9.js";import{u as L}from"./Cnu9lElD.js";import"./CqWpXUGi.js";function U(y){return Array.from(y).map(p=>p.toString(16).padStart(2,"0")).join(" ")}function q(y){const p=y.trim();if(/^[0-9a-f\s]+$/i.test(p)){const e=p.split(/\s+/).filter(Boolean);if(e.some(t=>t.length>2))throw new Error("invalidHexByte");return new Uint8Array(e.map(t=>Number.parseInt(t,16)))}return z(p)}async function F(y){if(!y.trim())return[];const e=(await T(()=>import("./Dz7Gw-MZ.js").then(a=>a.i),__vite__mapDeps([0,1,2,3]),import.meta.url)).parse(y,{keepCase:!0}).root,t=[],m=(a,l="")=>{for(const[f,o]of Object.entries(a)){if(!o||typeof o!="object")continue;const _=l?`${l}.${f}`:f;"fields"in o&&t.push(_);const b=o.nested;b&&m(b,_)}},c=e.nested;return c&&m(c),t}async function G(y,p,e,t={}){const a=(await T(()=>import("./Dz7Gw-MZ.js").then(_=>_.i),__vite__mapDeps([0,1,2,3]),import.meta.url)).parse(y,{keepCase:!0}).root.lookupType(p),l=JSON.parse(e),f=a.verify(l);if(f)throw new Error(`${t.verification??"Verification"}: ${f}`);const o=a.encode(a.create(l)).finish();return`${t.hex??"Hex"} (${o.length} ${t.bytes??"bytes"}):
${U(o)}
